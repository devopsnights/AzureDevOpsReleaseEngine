...
resource azureSqlDatabase_serverName 'Microsoft.Sql/servers@2020-02-02-preview' = {
...
resource azureSqlDatabase_serverName_azureSqlDatabase_databaseName 'Microsoft.Sql/servers/databases@2020-08-01-preview' = {
...
resource azureSqlDatabase_serverName_azureSqlDatabase_databaseName_Microsoft_Insights_default_logAnalytics_name 'Microsoft.Sql/servers/databases/providers/diagnosticSettings@2017-05-01-preview' = {
  ...
  dependsOn: [
    azureSqlDatabase_serverName_azureSqlDatabase_databaseName
    azureSqlDatabase_serverName_master
  ]
}
...
resource azureAppService_webSiteName 'Microsoft.Web/sites@2020-06-01' = {
...
resource ServerErrors_azureAppService_webSiteName 'microsoft.insights/metricAlerts@2018-03-01' = {
  ...
  properties: {
    ...
    enabled: true
    scopes: [
      azureAppService_webSiteName.id
    ]
...
resource ForbiddenRequests_azureAppService_webSiteName 'microsoft.insights/metricAlerts@2018-03-01' = {
